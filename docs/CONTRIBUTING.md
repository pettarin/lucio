...
[Code of Conduct](https://github.com/pettarin/lucio/blob/main/docs/CODE_OF_CONDUCT.md).
...
[GitHub Issues](https://github.com/pettarin/lucio/issues).
...
- When reporting a defect, please state the `lucio` version
  you are using, and the steps to reproduce your problem
  (e.g., a sequence of commands with the `.template.md` or `.md` file(s), etc.).
...
- Your PR is from a fix branch or feature branch (ideally branched off
  ...
  following the
  [Branching And Versioning Policy](https://github.com/pettarin/lucio/blob/main/docs/DEVELOPMENT.md#branching-and-versioning-policy).
