...
micromamba-create:
	micromamba create -n lucio_env python==3.13 --yes

micromamba-install-e-this:
	micromamba run -n lucio_env make install-e-this

micromamba-remove:
	micromamba env remove -n lucio_env --yes
...
micromamba-create-dev:
	micromamba create -n lucio_dev python==3.13 --yes

micromamba-install-e-this-dev:
	micromamba run -n lucio_dev make install-e-this-dev

micromamba-remove-dev:
	micromamba env remove -n lucio_dev --yes
